...
insert into movie (title, director, production_house) values 
	('Rush Hour', 'Brett Ratner', 'Roger Birnbaum Productions'),
	('May Who', 'Chayanop Boonprakob', 'Vanridee Pongsittisak'),
	('Fast And Forious', 'Vin Diesel', 'Universal Studio'),
	('Fast And Forious', 'Justin Lin', 'Universal Studio'),
	('First Blood', 'Ted Kotcheff', 'The Wallis Interactive'),
	('Top Gun', 'Tony Scott', 'Paramount Pictures');
